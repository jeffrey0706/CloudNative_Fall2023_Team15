...
function Location({ currentPlace, onClick = () => { } }) {
  return (
    <Container className='loc-div'>
      <Row className='location'>
        ...
        <Col xs={{ size: 2 }} sm={{ size: 1 }} className='map-icon-col'><Badge color='dark' className='map-icon' onClick={onClick}><FiMap size={20} /></Badge></Col>
      </Row>
      <Row>
